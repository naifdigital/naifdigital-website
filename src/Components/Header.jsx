        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            <div className="ml-4 flex items-center space-x-3">
              <Link
                to="/login"
                className="px-4 py-2 text-sm font-medium text-[#005587] hover:text-[#003366] transition"
              >
                Client Login
              </Link>
              <Link to="/get-started" className="inline-flex items-center group">
  <button className="px-6 py-2.5 text-[#00B3CC] text-sm font-medium border-2 border-[#00B3CC] bg-transparent hover:bg-[#00B3CC] hover:text-white hover:shadow-md transition-all duration-300 transform hover:-translate-y-0.5">
    Hire Us
  </button>
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4 pb-6 animate-fadeIn">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 space-y-3">
              <Link
                to="/login"
                className="block w-full px-4 py-2.5 text-center text-sm font-medium text-[#005587] hover:bg-gray-50 rounded-lg transition"
              >
                Client Login
              </Link>
              <Link
