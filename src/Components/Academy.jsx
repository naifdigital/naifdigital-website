    ...
    const courses = [
      {
        ...
        description: "12-week intensive training on cutting-edge technologies and digital strategies.",
        category: "CERTIFICATION",
        features: ["Live mentorship", "Case studies", "Capstone project"],
        duration: "3 Months",
        level: "Advanced",
      ...
      {
        title: "AI Leadership Course",
        description: "Executive program for leading AI-driven transformation in enterprises.",
        category: "EXECUTIVE",
        features: ["Industry frameworks", "Ethical AI", "Implementation blueprints"],
        duration: "6 Weeks",
        level: "Leadership",
      ...
      },
      {
        ...
        description: "Hands-on training for designing global-scale cloud infrastructure.",
        category: "BOOTCAMP",
        features: ["Multi-cloud labs", "Security protocols", "Cost optimization"],
        duration: "8 Weeks",
        level: "Intermediate",
